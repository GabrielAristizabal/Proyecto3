...
public class PagarHabitacion extends JDialog implements ActionListener {
    ...
    public PagarHabitacion(PropertyManagementSystem PMS) {
        this.PMS = PMS;
        ...
        // Consultar Button
        btnConsultar = new JButton("Pagar");
        ...
        btnConsultar.setActionCommand("PAGAR");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals("PAGAR")){			
			...
			if(habitacion != null) {
				CheckOut checkout = new CheckOut(PMS, habitacion);
			}
		}
